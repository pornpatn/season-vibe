...
-- CreateIndex
CREATE UNIQUE INDEX "ParLevel_inventoryItemId_dayOfWeek_key" ON "ParLevel"("inventoryItemId", "dayOfWeek");
...
-- AddForeignKey
ALTER TABLE "ParLevel" ADD CONSTRAINT "ParLevel_inventoryItemId_fkey" FOREIGN KEY ("inventoryItemId") REFERENCES "InventoryItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
